...
namespace SegmentedControl.FormsPlugin.Abstractions
{
    ...
    public class SegmentedControl : View, IViewContainer<SegmentedControlOption>
	{
        ...
        public static readonly BindableProperty SelectedBackgroundColorProperty = BindableProperty.Create("SelectedBackgroundColor", typeof(Color), typeof(SegmentedControl), Color.White);
        ...
        public static readonly BindableProperty TextColorProperty = BindableProperty.Create("TextColor", typeof(Color), typeof(SegmentedControl), Color.White);
