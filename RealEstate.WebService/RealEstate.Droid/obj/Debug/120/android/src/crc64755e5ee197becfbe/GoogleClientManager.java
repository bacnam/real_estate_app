...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.GoogleClient.GoogleClientManager, Plugin.GoogleClient", GoogleClientManager.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == GoogleClientManager.class) {
			mono.android.TypeManager.Activate ("Plugin.GoogleClient.GoogleClientManager, Plugin.GoogleClient", "", this, new java.lang.Object[] {  });
		}
	}
